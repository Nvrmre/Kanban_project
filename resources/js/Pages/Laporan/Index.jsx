        ...
        datasets: [
            {
                data: [
                    taskData.complete,
                    taskData.to_do + taskData.in_progress,
                ],
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto p-4">
                <h2 className="text-3xl font-extrabold leading-tight text-blue-600 mb-6">
                    Task Report
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                    ...
                    <div
                        ref={chartRef}
                        className="bg-white p-6 rounded-lg shadow-md hover:outline-none hover:ring-2 hover:ring-blue-500 hover:ring-offset-2 transition duration-150 ease-in-out"
                    >
                        ...
                        <PrimaryButton
                            onClick={() =>
                                downloadChart(chartRef, "task_status")
                            }
                            className="mt-4"
                        >
                    ...
                    >
                        ...
                        <PrimaryButton
                            onClick={() =>
                                downloadChart(chartBarRef, "task_distribution")
                            }
                            className="mt-4"
                        >
                            <FaFileDownload className="mr-2" />
